...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn("org_type_id", "integer", (col) =>
      col.references("app.org_type.org_type_id").notNull(),
    )
    .addColumn("org_category_id", "integer", (col) =>
      col.references("app.org_category.org_category_id").notNull(),
    )
    .execute();
  ...
  await db.schema
    ...
    .addColumn("type_of_doc_id", "integer", (col) =>
      col.references("app.document_type.type_of_doc_id").notNull(),
    )
    ...
    .addColumn("parent_id", "integer", (col) =>
      col.references("app.documents.document_id"),
    )
  ...
  await db.schema
    ...
    .addColumn("document_id", "integer", (col) =>
      col.references("app.documents.document_id").notNull(),
    )
    ...
    .addColumn("discuss_pharmacy_integration", "boolean", (col) =>
      col.notNull(),
    )
  ...
  await db.schema
    ...
    .addColumn("product_id", "integer", (col) =>
      col.references("external.products.product_id").notNull(),
    )
    .addColumn("document_id", "integer", (col) =>
      col.references("app.documents.document_id").notNull(),
    )
  ...
  await db.schema
    ...
    .addColumn("date_marked_useful", "timestamp", (col) =>
      col.defaultTo(sql`now()`).notNull(),
    )
    .execute();
