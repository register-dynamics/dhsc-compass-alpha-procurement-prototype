...
export async function down(db: Kysely<any>): Promise<void> 
{
  ...
  await db.schema
    .alterTable("app.product_documents_useful")
    .addForeignKeyConstraint("product_evidence_useful_document_id_fkey", ["document_id"],"app.documents",["document_id"])
    .execute();
}
...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    .alterTable("app.product_documents_useful")
    .addForeignKeyConstraint("product_evidence_useful_evidence_id_fkey", ["evidence_id"],"app.evidence",["evidence_id"])
    .execute()
