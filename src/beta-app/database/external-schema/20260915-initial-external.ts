...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn("gmdn_code", "integer", (col) =>
      col.references("external.gmdn.gmdn_code").notNull(),
    )
    ...
    .addColumn("manufacturer_id", "integer", (col) =>
      col.references("external.manufacturers.manufacturer_id").notNull(),
    )
    .execute();
  ...
  await db.schema
    ...
    .addColumn("device_id", "integer", (col) =>
      col.references("external.device_type.device_id").notNull(),
    )
  ...
  await db
    ...
    .as(
      db
        .selectFrom("external.products as p")
        .leftJoin("external.device_type as t", "p.device_id", "t.device_id")
        .leftJoin(
          "external.manufacturers as m",
          "p.manufacturer_id",
          "m.manufacturer_id",
        )
